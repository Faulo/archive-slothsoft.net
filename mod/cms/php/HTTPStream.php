<?php
/***********************************************************************
 * \CMS\HTTPStream v1.00 28.05.2014 © Daniel Schulz
 * 
 * 	Changelog:
 *		v1.00 28.05.2014
 *			initial release
...
abstract class HTTPStream {
	...
	protected $heartbeatContent 	= null;			//character to send after each heartbeatInterval is reached
	protected $heartbeatEOL 		= null;			//character to send before new content, when heartbeatContent was sent
	protected $heartbeatInterval 	= TIME_SECOND;	//time without actual content before heartbeatContent is sent
	protected $heartbeatTimeout 	= TIME_HOUR;	//time without actual content before child is terminated
