	...
	*/
	...
	public function send($data = null) {
		...
		$this->setRequestHeader(
			'User-Agent', 
			sprintf(
				'Mozilla/5.0 (%s) %s (KHTML, like Gecko) %s',
				$this->_env['SERVER_NAME'], $this->_env['SERVER_SOFTWARE'], 'XMLHttpRequest/2.0'
			)
		);
		...
		if ($res !== false) {
			...
			$toCharset = 'UTF-8';
			$fromCharset = $this->_responseCharset
				? $this->_responseCharset
				: strtoupper(mb_detect_encoding($this->responseText)); //'ISO-8859-1'
