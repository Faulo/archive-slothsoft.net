...
$start = isset($this->httpRequest->input['chat-start'])
	? (int) $this->httpRequest->input['chat-start']
	: 0;
$end = isset($this->httpRequest->input['chat-end'])
	? (int) $this->httpRequest->input['chat-end']
	: time();
