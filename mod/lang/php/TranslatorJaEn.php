...
class TranslatorJaEn extends Translator {
	...
	public static function lookupPlayerUri($sourceKana) {
		static $uriList = [];
		$sourceKana = str_replace(['-', '.', ' '], '', $sourceKana);
	...
	const PLAYER_LENGTH_MIN = 1000;	//random??
	const PLAYER_LENGTH_MAX = 50000;	//52288; //"the audio for this file is currently unavailable."
